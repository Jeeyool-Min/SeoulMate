...
<body>
    ...
    <main>
	<article class="write">
     <h2 class="tit_write"> 혼자 알던 <b>여행 코스</b>를 공유해요</h2>
        <hr class="hr_write_title">
        <button id="button" onclick="duplicate()">Add From(+)</button>
        <button id="button" onclick="duplicate()">Delete From(-)</button>
        <div id="duplicater"> 
            <form name="writing_form" id="w_form">
                ...
                <div class="basicInfo" id="duplicater">
                <ul>
