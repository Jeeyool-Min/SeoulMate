...
<body class="popup_body">
    ...
    <form name="schInfo" id="schInfo" style="display: block;" method="POST" action="search_process.jsp">
        ...
        <div class ="filterWrap">
            <ul class="filter_ul">
                ...
                <li><span class="title"><label for="tripAges"> 연령대 </label></span>
                    <div class="tripDays"> 
                        <span class="set"><input type="checkbox" class="reset1" name="tripAges" id="chk09" value="10"><label for="chk09"> 10대 </label></span>
                        <span class="set"><input type="checkbox" class="reset1" name="tripAges" id="chk10" value="20·30"><label for="chk10"> 20·30 </label></span>
                        <span class="set"><input type="checkbox" class="reset1" name="tripAges" id="chk11" value="40·50"><label for="chk11"> 40·50 </label></span>
                        <span class="set"><input type="checkbox" class="reset1" name="tripAges" id="chk12" value="60+"><label for="chk12"> 60+ </label></span>
                    </div>
                </li>
                ...
                <li><span class="title"><label for="tripAccess"> 이동수단 </label></span>
                    <div class="tripAccess"> <!--div: 모든 체크박스 묶음 | span : 하나의 체크박스와 목록명 묶음 | input : 체크박스 label:목록명-->
                        ...
                        <span class="set"><input type="checkbox" class="reset1" name="tripAccess" id="chk18" value="18"><label for="chk18"> 택시 </label></span>
                ...
                <li><span class="title"><label for="tripKeyword"> 추가 키워드 </label></span>
                    <div class="tripKeyword">
                        <input type="text" id="tripKeyword" name="tripKeyword" placeholder="기타 키워드 입력(선택사항)"/>
